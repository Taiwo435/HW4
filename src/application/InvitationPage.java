...
public class InvitationPage {
	...
	//@JeremyGastelo added back button and changed invitationpage constuctor to include user
	Button backButton = new Button("Back");
        backButton.setStyle("-fx-font-size: 14px; -fx-background-color: #cccccc; -fx-border-radius: 5px;");
        backButton.setOnAction(a -> {
            new AdminHomePage(databaseHelper).show(primaryStage, currentUser);
        });
	    
	//backbutton added to the layout vbox
